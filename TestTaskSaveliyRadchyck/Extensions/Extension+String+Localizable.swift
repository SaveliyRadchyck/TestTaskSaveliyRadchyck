...
public extension String {
    ...
    func localized(tableName: String? = nil, bundle: Bundle = .localization, arguments: Dictionary<String, Any>? = nil) -> String {
    ...
    func localizedPlural(tableName: String? = nil, arguments: CVarArg...) -> String {
